...
*/
$config['csrf_protection']   = false; //defined('APP_CSRF_PROTECTION') ? APP_CSRF_PROTECTION : false;
...
$config['csrf_exclude_uris'] = ['api/*','forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+'];
