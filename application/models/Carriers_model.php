...
public function add($data) {
        ...
        $allowed_fields = ['nome', 'tipo', 'cnpj_placa', 'cidade', 'estado', 'motorista', 'status', 'perfex_saas_tenant_id'];
...
public function update($data, $id) {
    ...
    $allowed_fields = ['nome', 'tipo', 'cnpj_placa', 'cidade', 'estado', 'motorista', 'status'];
