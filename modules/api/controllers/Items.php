...
class Items extends REST_Controller {
    ...
    public function data_get($id = '') {
         ...
         // Pegue os parâmetros de paginação
    ...
    // Obtenha os dados da tabela com base nos parâmetros de paginação
    $data = $this->Api_model->get_table('items', $id, $page, $limit);

    if ($data) {
        // Obtenha os dados adicionais
     //   $data = $this->Api_model->get_api_custom_data($data, "customers", $id);
        
        // Sete a resposta com os dados paginados
       // $this->response($data['clients'], REST_Controller::HTTP_OK);
        $this->response(['total' => $data['total'], 'data' => $data['items']], REST_Controller::HTTP_OK); // Inclua total de clientes
    } else {
