...
class Translations extends REST_Controller
{
    ...
    public function get_get()
    {
        ...
        $data = [
            ...
            "client_3" => "Sem clientes no momento.",
            "client_4" => "Deseja deletar os clientes selecionados?",
            "client_5" => "A ação deletará ",
            "client_6" => "clientes. Deseja continuar",
            "client_7" => "Cofirmar",
            "client_edit" => "Editar cliente",
            "client_status_active" => "Ativo",
            "client_status_inactive" => "Inativo",
