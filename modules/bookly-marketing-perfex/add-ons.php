...
class Rednumber_Addons {
    ...
    function add_menu(){
        ...
        add_submenu_page( "elementor","elementor form addons", "<span style='color:#f18500'>Forms Add-ons </span><span class='update-plugins count-1'><span class='plugin-count'>36</span></span>", "manage_options", "elementor-forms-addons", array( $this, 'page_addons_elementor' ), 999 );
        ...
        add_submenu_page( "wpforms-overview", "addons", "<span style='color:#f18500'>Add-ons </span><span class='update-plugins count-1'><span class='plugin-count'>36</span></span>", "manage_options", "wpforms.dashboard-addons", array( $this, 'page_addons_wpforms' ),999 );
...
<p>This is a special pack including all add-on for contact form 7 issued by us and every released add-on!
                    ...
                    <a href="https://1.envato.market/PqNN6" target="_blank" class="add-ons-box-actions-button-download">Get Now</a>
                </div>
                <?php
                }
            ?>
